...
final class GetDeletedProductModelDocumentIds
{
    ...
    {
        foreach ($this->getProductModelDocumentIds() as $indexedIdentifiers) {
            foreach ($this->getNonExistingModelIds($indexedIdentifiers) as $documentId) {
                yield $documentId;
            }
        }
    }
     ...
     */
    private function getProductModelDocumentIds(): iterable
    {
        $query = [
            'sort' => ['id' => 'asc'],
     ...
     * @return string[]
     */
    private function getNonExistingModelIds(array $indexedIdentifiers): array
    {
        ...
        return \array_values(\array_diff($indexedIdentifiers, $existingProductModelCodes));
    }
}
